...
(define test-list
  '(
    ...
    (app-1 "((lambda ((x ?)) x) (3))" int)
    (app-2 "((lambda ((x ?)) (+ x 1)) (3))" int)
    (app-3 "((lambda ((x ?)) (- x 1)) (3))" int)
    (app-4 "((lambda ((x ?)) (if (zero? x) (+ x 1) (- x 1))) (0))" int)
    (app-5 "((lambda ((x ?) (y ?)) (+ x y)) (3 4))" int)
    (app-6 "(((lambda ((x ?)) (lambda ((y ?)) (+ x y))) (3)) (4))" int)
    (app-8 "((lambda ((x ?)) (zero? x)) (3))" bool)
    (app-9 "((lambda ((x ?)) (not (zero? x))) (3))" bool)
    (let-1 "(let ((x 3)) x)" int)
    ...
    (add-exp-type-error-1 "(+ 5 (zero? 3))" "unification failure: bool (actual) != int (expected)")
    (add-exp-type-error-2 "(+ (zero? 0) 7)" "unification failure: bool (actual) != int (expected)")
    (diff-exp-type-error-1 "(- 52 (zero? 11))" "unification failure: bool (actual) != int (expected)")
    (diff-exp-type-error-2 "(- (zero? 12) 23)" "unification failure: bool (actual) != int (expected)")
    (zero-exp-type-error-1 "(zero? (zero? 1))" "unification failure: bool (actual) != int (expected)")
    (less-than-type-error-1 "(< 5 (zero? 1))" "unification failure: bool (actual) != int (expected)")
    (less-than-type-error-2 "(< (zero? 100) 6)" "unification failure: bool (actual) != int (expected)")
    (not-type-error-1 "(not 5)" "unification failure: int (actual) != bool (expected)")
